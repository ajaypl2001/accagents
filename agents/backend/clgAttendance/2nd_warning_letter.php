...
$query23 = "SELECT sno, update_datetime FROM start_college_attendance WHERE warning_letter='2nd_warning_letter' AND app_id='$snoid'";
...
<b><u>Re: 2nd Warning – Attendance Letter</u></b>
<br><Br>We are writing to advice you that you have missed 5 consecutive classes of your scheduled study time. As this is a second warning, we feel it is necessary to remind you of your academic/attendance obligations. In order to graduate and receive your diploma, you must achieve at least an overall of 75% attendance. <br><br>
At this time, we feel it is appropriate to provide you with this gentle reminder of your academic/attendance obligations. If you are not in attendance for your program, your academic standing will be in jeopardy. <br><br>
As an international student here in Canada, the IRCC expects that you will successfully complete the program you started and maintain full time attendance.  <br><br>
At this point, should your attendance not improve, you will be withdrawn from the program and IRCC will be notified. This happens in case of 10 consecutive missed classes.  <br><br>
We would also like to take this opportunity to remind you that if you need any further counseling/assistance in regard to this, we are here to assist you.
...
$olname = '2nd_WL_'.$firstname.'_'.$refid;

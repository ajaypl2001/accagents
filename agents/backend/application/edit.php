...
?>  
<style>
.btn-download { padding:0px 10px; height:25px; line-height:22px;font-size:13px;}
...
<div class="container vertical_tab">
  <div class="row">  
	...
	<li>
	<span class="btn add" id="show_personal_details"><span class="fas fa-user"></span> <span class="mb-hide">Personal Details</span></span>
	</li>
	<?php if(($personal_status == '1')){ ?> 
	<li>
	<span class="btn add_academic" id="show_acedmic_details"><span class="fas fa-university"></span><span class="mb-hide"> Academic Details</span></span>
	</li>
 
	<li>
		<span class="btn add_academic_doc" id="show_acedmic_details_doc">
		<i class="fas fa-upload"></i><span class="mb-hide"> Upload Docs</span>
		</span>
    </li>
	<?php } else { ?>
		   
    <li><span class="btn" id="profileStatus<?php echo $sessionid1;?>" style="color: #fff;background:#da5d5d;"><span class="mb-hide">Academic <br />Details</span></span></li>
	...
	<?php } else { ?>
    <li>
	<span class="btn" id="academicStatus<?php echo $sessionid1;?>" style="color: #fff;background:#da5d5d;"><span class="fas fa-book"></span><span class="mb-hide"> Choose Course</span></span>
	</li>
	<?php }
	if(($personal_status == '1') && ($idproof !== '') && ($academic_status ==1) && ($ielts_file !== '' || $Toefl_file !== '' || $pte_file !== '' || $duolingo_file !== '') && ($certificate1 !== '') && ($course_status ==1)){
	?>
	<li>
	<span class="btn add_document" id="show_docs_details"><span class="fas fa-upload"></span><span class="mb-hide"> Submit Form</span></span>
	</li>
	<?php }else{ ?>
    <li>
	<span class="btn" id="uploadDocument_status<?php echo $sessionid1;?>" style="color: #fff;background:#da5d5d;"><span class="fas fa-upload"></span> <span class="mb-hide">Submit Form</span></span>
	</li>
    <?php } ?>		
    </ul> 
...
<div class="col-sm-12">
	...
	<?php
	$results = mysqli_query($con, "SELECT created_by_id FROM allusers WHERE sno='$user_id'");
		...
		<div class="col-sm-4 form-group">
			<label>Mobile No:<span style="color:red;">*</span></label>
			 <div class="input-group ccCode">
				...
				<input id="dialCode" type="text" name="mobile" class="form-control is_require" value="<?php echo $mobile;?>">
	...
	<div class="input-group ccCode2">
		<span class="input-group-addon" id="icon"><i class="fas fa-mobile-alt"></i></span>
		<input id="dialCode2" type="text" name="emergency_contact_no" class="form-control is_require" value="<?php echo $emergency_contact_no;?>">
	...
	<div class="col-sm-4 form-group">
		<label>State:<span style="color:red;">*</span></label>
		 <div class="input-group">
		   <span class="input-group-addon" id="icon"><i class="far fa-building"></i></span>
	...
	<div class="col-sm-4 form-group">
		<label>City:<span style="color:red;">*</span></label>
		 <div class="input-group">
			<span class="input-group-addon" id="icon"><i class="fas fa-building"></i></span>
	...
	<div class="col-sm-4 form-group">
		<label>PIN Code:<span style="color:red;">*</span></label>
		 <div class="input-group">
		  <span class="input-group-addon" id="icon"><i class="far fa-comment-dots"></i></span>
	...
	<div class="col-sm-4 form-group">
		<label>Passport Number:<span style="color:red;">*</span></label>
		 <div class="input-group">
		  <span class="input-group-addon" id="icon"><i class="fas fa-tasks"></i></span>
		<input type="text" name="passport_no" id="datepicker" placeholder="Passport Number." class="form-control is_require" value="<?php echo $passport_no;?>">
	</div>
	</div>
	<div class="col-sm-4 form-group">
 ...
 <div class="col-sm-12">
	<h3><b>Test Details(<span style="color:red;">*</span><small>Required</small>)</b></h3>	
	 ...
	 <span class="input-group-addon" id="icon"><i class="far fa-copy"></i></span>
		<select name="englishpro" id="selectQ" class="is_require1 form-control">
...
<div class="col-sm-12" id="eiltsdiv" style="display:none;">
	...
	<div class="input-group">
		...
		<select name="ieltsover" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>
	...
	<div class="input-group">
		...
		<select name="ieltsnot" class="form-control1 form-control  is_require1">
		   <option value="" >Choose Option</option>
		   <option value="4" <?php if ($ieltsnot == "4") { echo 'selected="selected"'; } ?>>4</option>
		   <option value="4.5" <?php if ($ieltsnot == "4.5") { echo 'selected="selected"'; } ?>>4.5</option>
		   <option value="5" <?php if ($ieltsnot == "5") { echo 'selected="selected"'; } ?>>5</option>
	...
	<div class="input-group">
		...
		<select name="ielts_listening" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>
		   <option value="4" <?php if ($ielts_listening == "4") { echo 'selected="selected"'; } ?>>4</option>
		   <option value="4.5" <?php if ($ielts_listening == "4.5") { echo 'selected="selected"'; } ?>>4.5</option>
		   <option value="5" <?php if ($ielts_listening == "5") { echo 'selected="selected"'; } ?>>5</option>
	...
	<div class="input-group">
		...
		<select name="ielts_reading" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>
		   <option value="4" <?php if ($ielts_reading == "4") { echo 'selected="selected"'; } ?>>4</option>
		   <option value="4.5" <?php if ($ielts_reading == "4.5") { echo 'selected="selected"'; } ?>>4.5</option>
		   <option value="5" <?php if ($ielts_reading == "5") { echo 'selected="selected"'; } ?>>5</option>
	...
	<div class="input-group">
		...
		<select name="ielts_writing" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>
		   <option value="4" <?php if ($ielts_writing == "4") { echo 'selected="selected"'; } ?>>4</option>
		   <option value="4.5" <?php if ($ielts_writing == "4.5") { echo 'selected="selected"'; } ?>>4.5</option>
		   <option value="5" <?php if ($ielts_writing == "5") { echo 'selected="selected"'; } ?>>5</option>
	...
	<div class="input-group">
		...
		<select name="ielts_speaking" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>
		   <option value="4" <?php if ($ielts_speaking == "4") { echo 'selected="selected"'; } ?>>4</option>
		   <option value="4.5" <?php if ($ielts_speaking == "4.5") { echo 'selected="selected"'; } ?>>4.5</option>
		   <option value="5" <?php if ($ielts_speaking == "5") { echo 'selected="selected"'; } ?>>5</option>
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-calendar"></i></span>
		<input type="text" name="ielts_date" class="form-control1 form-control datepicker123 is_require1" value="<?php if(isset($ielts_date)){ echo $ielts_date; }?>">
	</div>
	</div>
...
<div class="col-sm-12" id="Toefldiv" style="display:none;">
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-sync"></i></span>
		<select name="Toeflover" class="form-control form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   for( $it=46; $it<=120; $it++ ){ ?>		   
	...
	<!--div class="col-sm-4 form-group">
	<label>Toefl Band not Less than<span style="color:red;">*</span></label>
	<div class="input-group">
		<select name="Toeflnot" class="form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   //for( $il=7; $il<=30; $il++ ){ ?>		   
		   <option value="<?php //echo $il;?>" <?php //if ($Toeflnot == "$il") { echo 'selected="selected"'; //} ?>><?php //echo $il; ?></option>
		  <?php //} ?>		   
	   </select>
	</div>
	</div-->
...
<!--- PTE  -->	
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-sync"></i></span>
		<select name="pteover" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   for( $i=30; $i<=90; $i++ ){ ?>		   
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-less-than"></i></span>
		<select name="ptenot" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   for( $i=30; $i<=90; $i++ ){ ?>		   
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-headphones"></i></span>
		<select name="pte_listening" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>
		   <?php 
		   for( $i=30; $i<=90; $i++ ){ ?>		   
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-book-open"></i></span>
		<select name="pte_reading" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   for( $i=30; $i<=90; $i++ ){ ?>		   
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-edit"></i></span>
		<select name="pte_writing" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   for( $i=30; $i<=90; $i++ ){ ?>		   
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-volume-up"></i></span>
		<select name="pte_speaking" class="form-control1 form-control is_require1">
		   <option value="" >Choose Option</option>		   
		   <?php 
		   for( $i=30; $i<=90; $i++ ){ ?>		   
	...
	<div class="input-group">
		<span class="input-group-addon" id="icon"><i class="fas fa-calendar"></i></span>
		<input type="text" name="pte_date" class="form-control1 form-control datepicker123 is_require1" id="ielts_date_val" value="<?php if(isset($pte_date)){ echo $pte_date; }?>">
	</div>
	</div>
	<div class="col-sm-4 form-group">
...
<!--- Duolingo -->	
	...
	<div class="input-group"><span class="input-group-addon" id="icon"><i class="fas fa-sync"></i></span>
...
<script>	
	...
	<label>Passing Year<span style="color:red;">*</span></label>
		...
		<div class="input-group">
			<span class="input-group-addon" id="icon"><i class="fas fa-calendar"></i></span>
		<select class="form-control pass_year_div" name="passing_year_gap">
		  <option value="">Select Option</option>
...
?>
	...
	<div class="col-sm-6 input-group jobDiv" style="display:<?php echo $jobDiv; ?>;">
...
<table class="table table-bordered">  
	...
	<tr>
		...
		<form action="../uploadpro.php" enctype="multipart/form-data" class="form-horizontal-docu1" method="post">	
			...
			<div class="progress-bar progress-bar-success progress-bar-striped pbClass1" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%">
			0%
			</div>
			</div>
	...
	if($englishpro == 'Toefl'){
		$englishpro_div = 'Toefl';
		$input_name = 'Toefl_file';
		if(!empty($Toefl_file)){
			$download_english = "<a class='btn btn-success btn-download mt-1' href='../../uploads/".$Toefl_file."' download>Download Toefl</a>";
		}else{
			$download_english = '';
		}
		$size_english = '(upload PDF or ZIP file), Maximum Size: 2MB';
	...
	?>
		...
		<form action="../uploadpro.php" enctype="multipart/form-data" class="form-horizontal-docu2" method="post">	
			...
			<div class="progress-bar progress-bar-success progress-bar-striped pbClass2" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%">
			0%
			</div>
			</div>
...
<?php if(!empty($qualification1)){ ?>	
	<tr>
		...
		<form action="../uploadpro.php" enctype="multipart/form-data" class="form-horizontal-docu3" method="post">	
			...
			<div class="progress-bar progress-bar-success progress-bar-striped pbClass3" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%">
			0%
			</div>
			</div>
...
<!--- Course Program1 --->	
	...
	<select name="intake" class="form-control intkeAppend is_require2" data-campus="<?php echo $campus; ?>">
		<option value="">Select Option</option>		
		<?php 
		$intakeFetch = mysqli_query($con, "Select intake from contract_courses where campus='$campus' group by intake");
...
<!--- Personal Details --->	
    ...
    <h3><b>Courses</b></h3>
    <div class="form-group">
      <label class="control-label" for="email"><b>Campus Name: </b></label>
...
<div class="col-sm-12 col-lg-6 col-md-6">
	...
	<div class="form-group">
      <label class="control-label" for="email">Toefl File: </label>
		<span>
    ...
    <div class="form-group">
      <label class="control-label" for="email"><b>Last Qualification:</b></label>
    ...
    <div class="form-group">
      <label class="control-label" for="email"><b>Qualifications:</b> </label>

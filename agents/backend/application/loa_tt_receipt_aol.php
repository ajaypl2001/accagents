...
$str_campus = "SELECT loa_receipt_id FROM st_application where sno='$snoid' AND campus!='' AND loa_receipt_id_admin='' AND loa_receipt_id=''";
...
if(mysqli_num_rows($rseult_campus)){
	...
	mysqli_query($con, "update `brm_loa_receipt_id` set availablility='', `st_sno`='' where  `st_sno`='$snoid'");
}
...
$querysid = "SELECT loa_receipt_id FROM st_application where sno='$snoid'";
 $rseultst_id = mysqli_query($con, $querysid);	
 while ($rowst_id = mysqli_fetch_assoc($rseultst_id)){
	 $loa_receipt_id = $rowst_id['loa_receipt_id'];
}

if($loa_receipt_id ==''){	
	mysqli_query($con, "update `st_application` set loa_receipt_id='$loaid' where `sno`='$snoid'");
	mysqli_query($con, "update `ham_loa_receipt_id` set availablility='used', `st_sno`='$snoid' where `loaid`='$loaid'");
}
		 
$querysid_2 = "SELECT loa_receipt_id FROM st_application where sno='$snoid'";
$rseultst_id_2 = mysqli_query($con, $querysid_2);	
while ($rowst_id_2 = mysqli_fetch_assoc($rseultst_id_2)){
	$student_id_2 = $rowst_id_2['loa_receipt_id'];
}
...
$result2 = "SELECT loaid FROM brm_loa_receipt_id where availablility='' ORDER BY loaid ASC limit 1";
$qyaolid = mysqli_query($con, $result2);	
while ($row1 = mysqli_fetch_assoc($qyaolid)){
	$loaid = $row1['loaid'];	
}
...
if($loa_receipt_id ==''){		
	mysqli_query($con, "update `st_application` set loa_receipt_id='$loaid' where `sno`='$snoid'");
	mysqli_query($con, "update `brm_loa_receipt_id` set availablility='used', `st_sno`='$snoid' where `loaid`='$loaid'");
}
...
$full_address = $address1.', '.$city.', '.$state.', '.$country.' '.$pincode;
$loa_receipt_id_1 = $rowstr1['loa_receipt_id'];
// $loa_file_date_updated_by = $rowstr1['loa_file_date_updated_by'];
$loa_file_date_updated_by = $rowstr1['loa_first_generate_date'];
...
<p class="m-1">PCCID: 101558<br>401 Bay Street, Suite 1000, 10th Floor, Toronto, On M5H 2Y4<br>T:416.969.8845 | F:416.969.9372 | <a href="https://aoltoronto.com/" target="blank">www.aoltoronto.com</a></td>';
	...
	$campus_addess = '<td rowspan="4" colspan="2" width="58%" class="pl-2" ><div class="logo1">
<img src="../../images/academy_of_learning_logo.png" width="220" class="logo"></div>
<p class="m-1">PCCID: 101558<br>8740 The Gore Road, Brampton, ON, L6P 0B1<br>T:905.508.5791 | F:289.948.1077 | <a href="https://aolbrampton.ca/" target="blank">www.aolbrampton.ca</a></td>';
}else{
	$campus_addess = '<td rowspan="4" colspan="2" width="58%" class="pl-2" ><div class="logo1">
<img src="../../images/academy_of_learning_logo.png" width="220" class="logo"></div>
<p class="m-1">PCCID: 101286<br>401 Main Street East, Hamilton, ON L8N 1J7<br>T:905.777.8553 | F:905.777.0103 | <a href="https://aolhamilton.com/" target="blank">www.aolhamilton.com</a></td>';
}

if($campus == 'Toronto'){

$output = "<style> @page { margin:2rem 40px 0.5rem;font-family:Arial, Helvetica, sans-serif; color:#333; font-size:15px;}
...
<td class="p-10 h-100" valign="top" align="right">$'.$genrate_amount_loa.'.00</td><td class="p-10 h-100" valign="top" align="right">$'.$genrate_amount_loa.'.00</td>
</tr>
<tr>
<td class="p-10"><h3 class="m-0">Total</h3></td>
<td class="p-10"><h3 class="m-0" style="font-weight:normal">$'.$genrate_amount_loa.'.00</h3></td>
</tr>
</table>
</div>
<div CLASS="mt-3">
...
$output = "<style> @page { margin:2rem 40px 0.5rem;font-family:Arial, Helvetica, sans-serif; color:#333; font-size:14px;page-break:never;}
...
$output .= '
<div style="page-break:never; ">
<table class="file-no" border="1" width="100%"> 
<tr>
'.$campus_addess.'
<td colspan="2" class="p-10" style="border-bottom:0px !important; padding-top:0px; padding-right:0px;" width="20%"><h3 class="m-0" style="width:180px;float:left;">Receipt # &nbsp; &nbsp; &nbsp; '.$loa_receipt_id_1.'</h3> <span style=" float:right; margin-top:-0px;width:120px;border-left:1px solid #333; height:26px; line-height:26px; text-align:center; border-bottom:1px solid #333;">OFFICE COPY</span></td>

  </tr>
  <tr>
<td class="p-10" width="25%">Date</td>
<td class="p-10" style="border-top:0px;" width="25%" align="center"><span>'.$loa_file_date_updated_by_1.'</span></td></tr>
<tr>
<td width="25%" class="p-10">RECEIVED BY</td>
<td width="25%" align="center"><span>ADMISSIONS</span></td></tr>
<tr>
<td class="p-10 no-border-bottom"  width="25%">&nbsp;</td>
<td class="p-10 no-border-bottom"  width="25%" align="center">-------</td>
</tr>
<tr>
<td width="25%" class="p-10">Student Information</td>
<td width="25%" class="p-10" align="center">STUDENT ID</td>
...
<td width="25%" class="p-10" align="center">1st PAYMENT</td></tr>
<tr>
<td width="25%" valign="top" rowspan="3" class="p-10">'.$fname.''.$lname.'<br>DOB: '.$dob.'<br>'.$full_address.'</td>
<td width="25%" class="p-10"  align="center">AOL '.$student_id.'</td>
<td width="25%" class="p-10" align="center">-----</td>
<td class="p-10" align="center">Yes</td></tr>
<tr>
<td class="p-10" align="center">PAYMENT METHOD</td>
<td class="p-10" align="center">FUNDING</td>
<td class="p-10" align="center">START DATE</td></tr>
<tr>
<td class="p-10" align="center">Bank Transfer</td>
<td class="p-10 no-border-bottom" align="center">-------</td>
<td class="p-10" align="center">'.$commenc_date.'</td></tr>
<tr><td width="25%" class="p-10" align="center">PROGRAM </td>
<td width="25%" class="p-10" align="center">PROGRAM LENGTH</td>
<td width="25%" class="p-10" align="center">CLASS</td>
<td width="25%" class="p-10" align="center">END DATE</td></tr>
<tr>
<td width="25%" class="p-10 no-border-bottom">'.$pn.'</td>
<td width="25%" class="p-10" style="border-bottom:1px solid #333;" align="center">'.$week.'</td>
<td width="25%" class="p-10 no-border-bottom" align="center">-------</td>
<td width="25%" class="p-10 no-border-bottom" align="center">'.$expected_date.'</td></tr>
</table>
<table border="1" width="100%" style="margin-top:0px;">
<tr bgcolor="#eee">
<td width="25%" class="p-10">Item</td>
<td width="35%" class="p-10" align="center" style="border-top:0px;">Description</td>
<td width="20%" class="p-10" align="center" style="border-top:0px;">Rate</td>
<td width="20%" class="p-10" align="center">Amount</td></tr>
<tr>
<td width="25%" rowspan="2" valign="top" class="p-10">International Student</td>
<td width="35%"  rowspan="2" valign="top"class="p-10">International student fee</td>
<td class="p-10 h-100" valign="top" align="center">$'.$genrate_amount_loa.'.00</td><td class="p-10 h-100" valign="top" align="center">$'.$genrate_amount_loa.'.00</td>
</tr>
<tr>
<td class="p-10"><h3 class="m-0">Total</h3></td>
<td class="p-10"><h3 class="m-0" align="center" style="font-weight:normal">$'.$genrate_amount_loa.'.00</h3></td>
</tr>
</table>
</div>
<div CLASS="mt-3">
...
<tr>
'.$campus_addess.'
<td class="p-10" colspan="2" style="border-bottom:0px !important; padding-top:0px; padding-right:0px;" width="20%"><h3 class="m-0" style="width:180px;float:left;">Receipt #  &nbsp; &nbsp; &nbsp; '.$loa_receipt_id_1.'</h3><span style=" float:right; margin-top:-0px;width:120px;border-left:1px solid #333; height:26px; line-height:26px; text-align:center; border-bottom:1px solid #333;">STUDENT COPY</span></td>
  </tr>
  <tr>
<td class="p-10" width="25%">Date</td>
<td class="p-10" width="25%" style="border-top:0px;" align="center"><span>'.$loa_file_date_updated_by_1.'</span></td></tr>
<tr>
<td width="25%" class="p-10">RECEIVED BY</td>
<td width="25%" align="center"><span>ADMISSIONS</span></td></tr>
<tr>
...
mysqli_query($con, "update `st_application` set `loa_receipt_file`='$filepath', `genrate_amount_loa`='$genrate_amount_loa', `genrate_amount_loa_date`='$col_updated' where `sno`='$snoid'");

mysqli_query($con, "INSERT INTO `notification_aol` (`role`, `application_id`, `fullname`, `agent_id`, `refid`, `post`, `stage`, `url`, `status`, `created`) VALUES ('$adminrole1', '$sno', '$fullname', '$user_id', '$refid', 'Receipt', 'Receipt', 'application?aid=error_$sno', '1', '$col_updated')");

mysqli_query($con, "INSERT INTO `notification_aol` (`role`, `application_id`, `fullname`, `agent_id`, `refid`, `post`, `stage`, `url`, `status`, `created`, `report_noti`) VALUES ('Admin', '$sno', '$fullname', '$user_id', '$refid', 'Receipt', 'TT Receipt', 'report/loa_receipt.php?aid=error_$sno', '1', '$col_updated', 'Yes')");

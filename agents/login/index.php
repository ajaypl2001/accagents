...
$('.btnlogin').on('click',function (e) {
	...
	if(emailForm == "" && pwdform == "") {
		...
		$('.loading_icon').hide();
		if(data == "bkdb"){
			window.location.href = "<?php echo $protocol3;?>localhost/accagents/agents/backend/application/";
		} 
		else if(data == "urldashboard"){
			window.location.href = "<?php echo $protocol3;?>localhost/accagents/agents/application/";		
		}
		else if(data == "clg"){
			window.location.href = "<?php echo $protocol3;?>localhost/accagents/agents/backend/collegeStart/index.php";		
		}  
		else if(data == "studenturl"){
			window.location.href = "<?php echo $protocol3;?>localhost/accagents/agents/application/";
		}
		else if(data == "report"){
			window.location.href = "<?php echo $protocol3;?>localhost/accagents/agents/backend/report/vgrapplication.php";
		}
		else if(data == "403"){

...
<td><b>Confirmation of Enrolment </b></td></tr>
...
<tr><td>
<p>This letter is to confirm that <b>'.ucfirst($fname).' '.ucfirst($lname).'</b> is enrolled in the <b>'.$prg_name1.'</b> (the “Program”) at Granville College. The Program commenced on <b>'.$commenc_date.' </b> and will end on <b>'.$expected_date.'.</b> <br><br>

The Programis full-time which is taught from Monday through Friday for '.$fullTimeDuration.' hours a day. The total length of the program is <b> '.$weekLenght.' weeks. </b>
<br><br>
Granville College is registered by the Private Training Institutions Branch and our programs are approved by the Ministry of Advanced Education.
<br><br>
...
$olname = 'COEnrmnt_'.$firstname.'_'.$refid;

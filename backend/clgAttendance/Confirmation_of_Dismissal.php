...
$query23 = "SELECT sno, update_datetime FROM start_college_attendance WHERE warning_letter='Confirmation_of_Dismissal' AND app_id='$snoid'";
...
<td><b>Confirmation of Dismissal </b></td></tr>
...
<tr><td>
<p>This letter is to confirm that <b>'.ucfirst($fname).' '.ucfirst($lname).' </b> was enrolled in the <b> '.$prg_name1.'</b>(the “Program”) at Granville College. The Program commenced on '.$commenc_date.' and the student was dismissed from the program on <b>'.$get_crnt_dte.'.</b> <br><br>

The Program is full-time which is taught from Monday through Friday for '.$fullTimeDuration.' hours a day. The total length of the program is <b>'.$weekLenght.' weeks. </b>
 <br><br>

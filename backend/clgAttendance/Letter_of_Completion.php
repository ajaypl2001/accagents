...
Dear '.ucfirst($fname).' '.ucfirst($lname).':<br><br>
<table>
<tr>
<td><b>RE:  </b></td>
<td><b>Letter of Completion</b></td></tr>
<tr><td><b>Student:  </b></td>
<td><b> '.ucfirst($fname).' '.ucfirst($lname).'</b></td>
</tr>
<tr>
...
<p>This letter is to confirm that <b>'.ucfirst($fname).' '.ucfirst($lname).' </b> has successfully completed all necessary requirements to graduate from the following program from Granville College. The details of the program are as under:<br><br>
<b>Program of Study: '.$prg_name1.'<br>
Program Length: '.$weekLenght.' weeks<br>
Program Start Date: '.$commenc_date.'<br>
Program End Date: '.$expected_date.'
</b></p>
<br><p>Should you require any further information or assistance, please feel free to contact us by phone <b>(604) 683-8850 </b> or via email <b>info@granvillecollege.ca</b>
...
$olname = 'LofCmpln_'.$firstname.'_'.$refid;

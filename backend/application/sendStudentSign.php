...
if(empty($stud_enrld)){
	...
	$m2 = '<p>To complete your Admission in <b>Avalon Community College</b>, please click the following link to review and sign the <b>Enrollment Contract</b>:</p>';
	$m3 = "<p><a href='https://avaloncommunitycollege.com/docsignD2/?$msssg2&id=$snoidEncode&tab=Signed&$msssg'>Click here to Sign</a></p>";
	...
	$m7 = '<p>Regards,<br>Admissions Team - Avalon Community College<br><img src="https://avaloncommunitycollege.com/portal/images/logo.jpg" style="pointer-events: none;width:140px;height:100px;"></p>';
	$msg_body = $m1.''.$m2.''.$m3.''.$m6.''.$m7;

	$subject = 'Contract Signature for Avalon Community College - '.$fname.' - '.$student_id.'';
	$to = $getEmail;
	$mail = new PHPMailer();	
	$mail->IsSMTP();
	...
	$mail->FromName = 'Contract Signature | Avalon Community College';
	$mail->AddAddress("$to");
	...
	if(!$mail->Send()){
		...
		$query = "update `st_app_more` set send_date='$datetime_at', send_date_by='$email2323', signed_contract='', signed_contract_datetime='', contract_status='', contract_remarks='', contract_datetime='' where `app_id`='$snoid'";

...
$str_campus = "SELECT loa_receipt_id FROM st_application where sno='$snoid' AND campus!='' AND loa_receipt_id=''";
...
<p class="m-1">PCCID: 101286<br>401 Main Street East, Hamilton, ON L8N 1J7<br>T:905.777.8553 | F:289.426.2734 | <a href="https://aolhamilton.com/" target="blank">www.aolhamilton.com</a></td>';
	...
	$campus_addess = '<td rowspan="4" colspan="2" width="58%" class="pl-2" ><div class="logo1">
<img src="../../images/logo_brampton.png" width="220" class="logo"></div>
<p class="m-1">PCCID: 101558<br>8740 The Gore Road, Brampton, ON, L6P 0B1<br>T:416.969.8845 | F:416.969.9372 | <a href="https://aolbrampton.ca/" target="blank">www.aolbrampton.ca</a></td>';
}else{
	$campus_addess = '<td rowspan="4" colspan="2" width="58%" class="pl-2" ><div class="logo1">

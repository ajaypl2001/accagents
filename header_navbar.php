...
<head>
  ...
  <?php 
	...
	if($get_title_url == "https://avaloncommunitycollege.com/portal/application/index.php"){
		echo "<title>";
		echo "Applications | Avalon Community College";
		echo "</title>";
	}
	elseif($get_title_url == "https://avaloncommunitycollege.com/portal/login/index.php"){
		echo "<title>";
...
$(document).ready(function(){
	...
	if(getloc =='https://avaloncommunitycollege.com/portal/backend/application/'){
	setTimeout(function(){  
